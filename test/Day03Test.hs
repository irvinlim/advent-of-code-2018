...
level2TestCases =
  [ ("Single claim should be the claim itself", ["#1 @ 1,3: 4x4"], 1)
  , ("Given test case", ["#1 @ 1,3: 4x4", "#2 @ 3,1: 4x4", "#3 @ 5,5: 2x2"], 3)
  ]
...
tests = TestLabel "Day 3" $ TestList [level1Tests, level2Tests]
